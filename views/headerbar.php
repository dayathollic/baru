                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                        <div class="avatar avatar-online">
                            <img src="../../assets/img/avatars/r4.png" alt class="rounded-circle">
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar avatar-online">
                                            <img src="../../assets/img/avatars/r4.png" alt class="rounded-circle"> 
                                            <!--<h5>Nur Hidayat</h5>-->
                                            <span class="align-right"><strong>Hello, </strong></span>
                        ...
                        <li>
                            <a class="dropdown-item" href="/staff/user/edit/change/<?php echo $value['id']; ?>"> <i class="fa-solid fa-lock me-2"></i>
                        ...
                        <li>
                            <a class="dropdown-item" href="<?='/login/logout';?>"> <i class="bx bx-power-off me-2"></i>

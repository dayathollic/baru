        ...
        <div class="col">
            <div class="accordion" id="collapsibleSection">
                <div class="card accordion-item">
                    <form method="POST" action="staffController.php?aksi=change&id=<?=$this->userEdit['id']; ?>">
                        <div class="accordion-body">
                            <div class="row g-3">
                                ...
                                <input type="hidden" name="username" value="<?=$this->userEdit['id']; ?>">
                                ...
                                <div>
                                    ...
                                    <!--<a href="/staff/user/edit/"  type="button" class="btn btn-outline-warning">Cancel</a>-->
